...
public class ConvertFromAttachment_faultMsg extends java.lang.Exception{
    ...
    private de.nrw.hbz.pdfaconverter.types.ConvertFromAttachment_fault faultMessage;
    ...
    public void setFaultMessage(de.nrw.hbz.pdfaconverter.types.ConvertFromAttachment_fault msg){
       faultMessage = msg;
    }
    
    public de.nrw.hbz.pdfaconverter.types.ConvertFromAttachment_fault getFaultMessage(){
       return faultMessage;
    }
}
