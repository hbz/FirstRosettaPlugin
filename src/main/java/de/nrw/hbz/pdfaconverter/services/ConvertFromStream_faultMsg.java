...
public class ConvertFromStream_faultMsg extends java.lang.Exception{
    ...
    private de.nrw.hbz.pdfaconverter.types.ConvertFromStream_fault faultMessage;
    ...
    public void setFaultMessage(de.nrw.hbz.pdfaconverter.types.ConvertFromStream_fault msg){
       faultMessage = msg;
    }
    
    public de.nrw.hbz.pdfaconverter.types.ConvertFromStream_fault getFaultMessage(){
       return faultMessage;
    }
}
