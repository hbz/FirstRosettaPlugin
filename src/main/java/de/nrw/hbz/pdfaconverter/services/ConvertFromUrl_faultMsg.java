...
public class ConvertFromUrl_faultMsg extends java.lang.Exception{
    ...
    private de.nrw.hbz.pdfaconverter.types.ConvertFromUrl_fault faultMessage;
    ...
    public void setFaultMessage(de.nrw.hbz.pdfaconverter.types.ConvertFromUrl_fault msg){
       faultMessage = msg;
    }
    
    public de.nrw.hbz.pdfaconverter.types.ConvertFromUrl_fault getFaultMessage(){
       return faultMessage;
    }
}
