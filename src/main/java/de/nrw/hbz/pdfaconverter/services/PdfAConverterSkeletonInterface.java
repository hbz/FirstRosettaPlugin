 ...
 */
    ...
    public interface PdfAConverterSkeletonInterface {
         ...
         */
                ...
                (
                		de.nrw.hbz.pdfaconverter.types.ConvertFromUrl convertFromUrl
                 )
            throws ConvertFromUrl_faultMsg;
         ...
         */
                ...
                (
                		de.nrw.hbz.pdfaconverter.types.ConvertFromAttachment convertFromAttachment
                 )
            throws ConvertFromAttachment_faultMsg;
         ...
         */
                ...
                (
                  de.nrw.hbz.pdfaconverter.services.BatchConvert batchConvert
                 )
            throws BatchConvertFaultException0;
         ...
         */
                ...
                (
                		de.nrw.hbz.pdfaconverter.types.ConvertFromStream convertFromStream
                 )
            throws ConvertFromStream_faultMsg;
