 ...
 */
            ...
            /**
            *  CompliancyLevelType bean class
            */
        
        public  class CompliancyLevelType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for CompliancyLevelType
                        */

                        
                                    protected java.lang.String localCompliancyLevelType ;
                                
                            private static java.util.HashMap _table_ = new java.util.HashMap();

                            // Constructor
                            
                                protected CompliancyLevelType(java.lang.String value, boolean isRegisterValue) {
                                    localCompliancyLevelType = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localCompliancyLevelType, this);
                                    ...
                                    public static final java.lang.String _value1 =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("1a");
                                ...
                                public java.lang.String toString() {
                                        ...
                                        return localCompliancyLevelType.toString();
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CompliancyLevelType.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                               ...
                               if (serializeType){
                                   ...
                                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           namespacePrefix+":compliancyLevelType",
                                           xmlWriter);
                                   } else {
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           "compliancyLevelType",
                                          ...
                                          if (localCompliancyLevelType==null){
                                            
                                                     throw new org.apache.axis2.databinding.ADBException("Value cannot be null !!");
                                                
                                         }else{
                                        
                                                       xmlWriter.writeCharacters(localCompliancyLevelType);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCompliancyLevelType)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static CompliancyLevelType fromValue(java.lang.String value)
                      throws java.lang.IllegalArgumentException {
                    CompliancyLevelType enumeration = (CompliancyLevelType)
                ...
                public static CompliancyLevelType fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static CompliancyLevelType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return CompliancyLevelType.Factory.fromString(content,namespaceUri);
                    } else {
                       return CompliancyLevelType.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static CompliancyLevelType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CompliancyLevelType object = null;
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = CompliancyLevelType.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = CompliancyLevelType.Factory.fromString(content,"");
                                        }
